...
def lang_note():
    ...
    doc_analyzed = lang_client.annotate_text(
...
def handle_entity_prompt():
    ...
    entity['pre_text'] = prompt_list['entity_pretext'][random.randrange(
        0, len(prompt_list['entity_pretext']))]
    return entity
...
def handle_sentence_prompt():
    ...
    sentence['pre_text'] = prompt_list[prompt_str][random.randrange(
        0, len(prompt_list[prompt_str]))]
    return sentence
